...
\input{4.Disenio/Introduccion.tex}
\input{4.Disenio/RepresentacionSistema}
\input{4.Disenio/ObjetivosYRestricciones}
\input{4.Disenio/VistaCasosUso}
\input{4.Disenio/VistaLogica}
\input{4.Disenio/VistaProceso}
\input{4.Disenio/VistaDesarrollo}
\input{4.Disenio/VistaImplementacion}
\input{4.Disenio/VistaDatos}
\input{4.Disenio/TamanioYRendimiento}
\input{4.Disenio/Calidad}
