...
%\usepackage[utf]{inputenc} % Cargamos 'latin1' para introducir tildes
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    ...
    \input{2.Gestion&Planificacion/Gestion&Planificacion.tex}
    \input{3.Analisis/Analisis.tex}%ERS/ERS.tex}
    \input{4.Disenio/Disenio.tex} %No le gusta la "ñ", asi que las sustituimos por "ni"
    \input{5.Implementacion&Pruebas/Implementacion&Pruebas.tex}
